...
export const LibraryIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => {
  return (
    <svg 
      ...
      strokeLinecap="round" 
      strokeLinejoin="round" 
      className={`feather feather-book-open ${className}`}
    >
...
export const AlbumsIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => {
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={size} 
...
export const CheckIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => {
  return (
    <svg 
      ...
      strokeLinecap="round" 
      strokeLinejoin="round" 
      className={`feather feather-check ${className}`}
    >
...
export const FolderIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => {
  return (
    <svg 
      ...
      strokeLinecap="round" 
      strokeLinejoin="round" 
      className={`feather feather-folder ${className}`}
    >
