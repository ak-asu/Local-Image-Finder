...
class AlbumCreate(BaseModel):
    ...
    result_limit: Optional[int] = None  # Number of results to save if creating from search query
...
async def update_album_details(
    ...
    updated_album = await update_album(
        profile_id, 
        album_id, 
...
@router.delete("/{profile_id}/{album_id}", response_model=dict)
...
@router.post("/{profile_id}/{album_id}/images/{image_id}", response_model=Album)
...
@router.delete("/{profile_id}/{album_id}/images/{image_id}", response_model=Album)
...
@router.put("/{profile_id}/{album_id}/order", response_model=Album)
